...
from app.routers import auth, student_indicator, import_router, category, proceedings, alert, dashboard, posgrado_indicator, grupo_inferir_indicator, base_laboratorio, user_management
